...
const Icons = () => {
    return (
        <section className='flex flex-col bg-[#F3F3F3]'>
            <div className='flex flex-col container mx-auto px-11 my-[160px] gap-[48px]'>
                <div className='flex flex-row gap-[48px]'>
                    ...
                    <div className='flex flex-col gap-[12px]'>
                        <h3 className='text-[#030E4A] text-[33.18px] lg:text-[39.81px] font-bold'>Команда</h3>
                ...
                <div className='flex flex-row gap-[48px]'>
                    ...
                    <div className='flex flex-col gap-[12px]'>
                        <h3 className='text-[#030E4A] text-[33.18px] lg:text-[39.81px] font-bold'>Ответственность</h3>
                ...
                <div className='flex flex-row gap-[48px]'>
                    ...
                    <div className='flex flex-col gap-[12px]'>
                        <h3 className='text-[#030E4A] text-[33.18px] lg:text-[39.81px] font-bold'>Качество</h3>
                ...
                <div className='flex flex-row gap-[48px]'>
                    ...
                    <div className='flex flex-col gap-[12px]'>
                        <h3 className='text-[#030E4A] text-[33.18px] lg:text-[39.81px] font-bold'>Развитие</h3>
                ...
                <div className='flex flex-row gap-[48px]'>
                    ...
                    <div className='flex flex-col gap-[12px]'>
                        <h3 className='text-[#030E4A] text-[33.18px] lg:text-[39.81px] font-bold'>Надежность</h3>
